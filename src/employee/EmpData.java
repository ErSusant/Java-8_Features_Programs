...
public class EmpData {
	...
	public static void main(String[] args) {
		...
		emps.add(new Employee(17,"Sanvi",22,"Female","Testing",2010,30000.0));
		
		//Q.1)How many males and females employees are there in the organisation
//		  Map<String, Long> map1 = emps.stream().collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
//		System.out.println(map1);
		
//		
//		List<Employee> collect = emps.stream().filter(e->e.getName().startsWith("A")).collect(Collectors.toList());
...
//		Q3)What is the average age of male and female employees in the organisation
//		Map<String, Double> map2 = emps.stream()
//		.collect(Collectors.groupingBy(Employee::getGender,Collectors.averagingInt(Employee::getAge)));
//		System.out.println(map2);
		
		//Q4) Get the details of highest paid employee in the organisation
...
//		Q5.get the names all the employees who have joined after 2015
		emps.stream()
